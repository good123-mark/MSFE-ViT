...
from .custom_seg_transforms import SegSlidingWindowCrop, SegSlidingWindowMerge
...
__all__ = ['__version__', 'version_info', 'digit_version', 'SegSlidingWindowCrop', SegSlidingWindowMerge]
